...
use ntesic\boilerplate\Widgets\Widget;
...
//    }
    ...
    public function renderCaption()
    {
        if (!empty($this->caption)) {
            return Tag::tag('caption', $this->caption, $this->captionOptions);
        } else {
            return false;
        }
    }
    ...
    public function renderTableFooter()
    {
        ...
        $content = Tag::tag('tr', implode('', $cells), $this->footerRowOptions);
    ...
    public function renderFilters()
    {
        if ($this->filterModel !== null) {
            ...
            return Tag::tag('tr', implode('', $cells), $this->filterRowOptions);
        } else {
            return '';
        }
    }
    ...
    public function renderTableRow($model, $key, $index)
    {
        ...
        return Tag::tag('tr', implode('', $cells), $options);
    }
    ...
    protected function initColumns()
    {
        ...
        foreach ($this->columns as $i => $column) {
            if (is_string($column)) {
                ...
                $class = $this->dataColumnClass ? $this->dataColumnClass : 'ntesic\boilerplate\Grid\DataColumn';
                if (isset($column['class']))
                    $class = $column['class'];
                $column = new $class(array_merge([
                    'grid' => $this,
                ], $column));
            }
            if (!$column->visible) {
