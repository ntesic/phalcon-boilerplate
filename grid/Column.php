...
class Column extends Component
{
    ...
    /**
     * Method that always execute on initializing
     */
    ...
    {
        return Tag::tag('th', $this->renderHeaderCellContent(), $this->headerOptions);
    }
    ...
    {
        return Tag::tag('td', $this->renderFooterCellContent(), $this->footerOptions);
    }
    ...
    public function renderDataCell($model, $key, $index)
    {
        ...
        return Tag::tag('td', $this->renderDataCellContent($model, $key, $index), $options);
    }
    ...
    {
        return Tag::tag('td', $this->renderFilterCellContent(), $this->filterOptions);
    }
