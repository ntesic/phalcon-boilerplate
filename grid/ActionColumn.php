...
class ActionColumn extends Column
{
    ...
    public function initDefaultButtons()
    {
        if (!isset($this->buttons['view'])) {
            $this->buttons['view'] = function ($url, $model, $key) {
                ...
                return Tag::linkTo($url, '<span class="glyphicon glyphicon-eye-open"></span>');
        ...
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                ...
                return Tag::linkTo($url, '<span class="glyphicon glyphicon-pencil"></span>');
        ...
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                ...
                return Tag::linkTo($url, '<span class="glyphicon glyphicon-trash"></span>');
    ...
    public function renderCellData($model, $key, $index)
    {
    ...
    public function createUrl($action, $model, $key, $index)
    {
        if (is_callable($this->urlCreator)) {
            ...
            $action = $this->router->getControllerName() ? $this->router->getControllerName() . '/' . $action : $action;
            return $this->url->get($action,$params);
        }
    }
