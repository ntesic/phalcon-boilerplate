...
<head>
    ...
    <?php
    if (array_key_exists('custom_css',$this->assets->getCollections())) {
        echo $this->assets->outputCss('custom_css');
    }
    ?>
</head>
...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <?php if ($page_title && !empty($page_title)) { ?>
                <h1>
                    <?= $page_title ?>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="text-center hidden-xs">
                    ...
                    Copyright &copy; <?= $copy_date ?> <?= $this->tag->linkTo($phalcon_url, $phalcon_team, false) ?>.
                    All rights reserved.<br>
                    <strong><?= $lte_name ?></strong>.
                    Copyright &copy; <?= $lte_name ?> <?= $this->tag->linkTo($lte_url, $lte_team, false) ?>. All rights
                    reserved.
                </div>
            </div>
        </div>
